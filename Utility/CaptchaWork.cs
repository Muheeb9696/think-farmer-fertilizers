...
namespace Utilities
{
    ...
    {
        const string Letters = "2346789ABCDEFGHJKLMNPRTUVWXYZ";//abcdefghijklmnpqrstuvwxyz

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Security", "SCS0005:Weak random generator", Justification = "<Pending>")]
